...
const Page = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col text-slate-800">
      <div
        className="w-full h-20 border-b border-slate-200 shadow-sm 
                      flex items-center md:justify-start justify-center px-8 bg-white/80 backdrop-blur-md"
      >
        <h1 className="text-xl text-center md:text-start md:text-3xl font-bold tracking-tight">
          Player Management
        </h1>
      </div>
      ...
      <div className="mx-auto max-w-7xl w-full px-6 mt-8 space-y-8">
        ...
        >
              ...
              availableDevices.map((d) => (
                <span
                  ...
                  className="bg-green-600 text-white px-3 py-1.5 rounded-full 
                            text-xs md:text-sm md:font-medium shadow-sm"
                >
                  {d.deviceName}
                </span>
              ))
          ...
          <span
            className="ml-auto text-slate-700 font-semibold text-sm 
